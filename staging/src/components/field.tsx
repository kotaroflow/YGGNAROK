...
export const buttonClass =
  "inline-flex h-11 items-center justify-center rounded-full bg-brand px-5 text-sm font-semibold text-neutral-950 shadow-sm transition hover:bg-brand-strong focus:ring-2 focus:ring-brand/20";
