                              ...
                              <form action={markManualPostAsPublishedAction} className="space-y-2.5 p-3.5 rounded-xl bg-surface-strong/20 border border-line/50">
                                ...
                                <div className="space-y-2">
                                  <input
                                    ...
                                    required
                                  />
                                  <button className="w-full h-8 rounded-lg bg-brand text-neutral-950 text-[9px] font-extrabold uppercase tracking-wider hover:bg-brand-strong transition flex items-center justify-center gap-1">
                                    <Send size={10} />
                                    <span>Finalizar</span>
                                  </button>
                                </div>
