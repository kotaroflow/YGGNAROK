...
const councilAgents = [
  { key: "creator", name: "Creator Agent", duty: "gera primeira versao, ideias, roteiros, textos, prompts e estruturas" },
  { key: "critic", name: "Critic Agent", duty: "encontra falhas, incoerencias, repeticao, baixa qualidade e fragilidade" },
  { key: "strategy", name: "Strategy Agent", duty: "melhora clareza, engajamento, vendas, afiliado, retencao e conversao" },
  { key: "consistency", name: "Consistency Agent", duty: "verifica perfil, nicho, regras, historico, estilo e identidade do YGGNAROK" },
  { key: "safety", name: "Safety/Governance Agent", duty: "classifica risco, custo, reversibilidade e bloqueia acoes perigosas" },
  { key: "memory", name: "Memory Agent", duty: "identifica aprendizados uteis e evita salvar lixo, erro ou alucinacao" },
  { key: "supervisor", name: "Supervisor Agent", duty: "resolve conflitos, decide rodadas e gera sintese final justificada" },
  { key: "momonga", name: "Momonga/Admin Override", duty: "autoridade maxima para high risk e governanca central" },
] as const;
...
export async function runOrchestratedAgent(input: OrchestrationInput) {
  ...
  return {
    ...
    metadata: {
      ...
      ai_orchestration: {
        architecture: "YGGNAROK_AI_COUNCIL",
        ...
        council_agents: councilAgents.map((agent) => ({
          ...
          name: agent.name,
          duty: agent.duty,
          active: agent.key !== "momonga" || requiresAdminApproval,
        })),
  ...
  return [
    {
      ...
      content: [
        input.agent.system,
        "Voce participa do YGGNAROK AI COUNCIL. Gere uma proposta completa para seu papel e deixe dados uteis para aprendizado futuro.",
  ...
  return [
    {
      role: "system" as const,
      content: [
        "Voce e um agente de debate do YGGNAROK AI COUNCIL.",
  ...
  return [
    {
      ...
      content: [
        input.agent.system,
        "Voce e o Supervisor Agent do YGGNAROK AI COUNCIL. Use o melhor dos candidatos e das criticas.",
  ...
  return [
    {
      ...
      content: [
        ...
        "Salve apenas preferencias, padroes, estrategias e alertas novos que ajudem proximas tarefas.",
        ...
        "Responda apenas JSON com: summary, keep, avoid, routing_hint, prompt_hint, risk, confidence, status.",
      ].join(" "),
    },
    {
      role: "user" as const,
