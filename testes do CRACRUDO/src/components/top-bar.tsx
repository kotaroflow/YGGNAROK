...
export function TopBar() {
  return (
    <header className="sticky top-0 z-[var(--z-page-effects)] flex h-14 shrink-0 items-center gap-3 border-b border-line bg-surface/80 px-4 pl-16 shadow-sm backdrop-blur-xl lg:pl-6">
      ...
      <Link
        href="/criar-conteudo"
        className="inline-flex h-9 items-center gap-2 rounded-full bg-brand px-4 text-sm font-semibold text-white dark:text-neutral-950 transition hover:bg-brand-strong"
      >
        <PenLine size={16} />
