      ...
      {!collapsed && (
        <>
          ...
          <div className="px-3 pb-2">
            <div className="flex h-9 rounded-lg bg-sidebar-hover/50 p-1">
              <button
                onClick={() => {
                  setActiveTab("chat");
          ...
          <div className="mt-auto p-3">
            <div className="group relative flex items-center justify-center rounded-lg px-2 py-2 transition hover:bg-sidebar-hover">
                ...
                <div className="flex min-w-0 flex-1 items-center gap-3">
                  ...
                  <div className="flex min-w-0 flex-col gap-1 opacity-100 transition-opacity duration-[260ms] ease-out">
                    <div className="flex min-w-0 items-center gap-1.5">
                      ...
                      <span
                        data-plan={planTag}
                        className="shrink-0 select-none rounded-md border border-brand/20 bg-brand px-1.5 py-0.5 text-[8px] font-black uppercase leading-none tracking-widest text-white dark:text-neutral-950 shadow-sm"
                      >
                        {planTag}
                      </span>
                    </div>
              ...
              <div className="absolute bottom-0 left-full ml-3.5 z-[var(--z-sidebar-popup)] w-64 origin-bottom-left rounded-xl border border-line bg-surface-overlay backdrop-blur-xl shadow-lg dark:shadow-[0_12px_40px_rgba(0,0,0,0.65)] p-2.5 opacity-0 invisible transition-all duration-300 scale-95 hover:scale-100 group-hover:opacity-100 group-hover:visible group-hover:scale-100">
                ...
                <div className="px-3 py-2.5 mb-2 rounded-lg bg-surface-base/80 border border-line/20 flex items-center gap-2.5 select-none">
                ...
                <div className="space-y-0.5">
                  <Link href="/meu-perfil" className="flex items-center gap-2 rounded-lg px-2.5 py-2 text-[12.5px] font-semibold text-sidebar-text hover:bg-sidebar-hover hover:text-brand transition-all duration-200 group/item">
                    <Globe size={14} className="text-muted group-hover/item:text-brand transition-colors" />
                    <span>Meu Perfil</span>
                  </Link>

                  <Link href="/configuracoes" className="flex items-center gap-2 rounded-lg px-2.5 py-2 text-[12.5px] font-semibold text-sidebar-text hover:bg-sidebar-hover hover:text-brand transition-all duration-200 group/item">
                    <Settings size={14} className="text-muted group-hover/item:text-brand transition-colors" />
                    <span>Configurações do OS</span>
                  </Link>

                  <Link href="/prompts" className="flex items-center gap-2 rounded-lg px-2.5 py-2 text-[12.5px] font-semibold text-sidebar-text hover:bg-sidebar-hover hover:text-brand transition-all duration-200 group/item">
                ...
                <form action={signOut}>
                  <button type="submit" className="flex w-full items-center gap-2 rounded-lg px-2.5 py-2 text-[12.5px] font-semibold text-sidebar-text hover:bg-sidebar-hover hover:text-brand transition-all duration-200 group/item">
