              ...
              >
                ...
                <div className="flex items-center gap-2 mt-auto pt-4 border-t border-line">
                  ...
                  <a
                    ...
                    className="flex items-center justify-center size-9 rounded-lg bg-brand text-white dark:text-neutral-950 hover:bg-brand-strong transition-colors shadow-sm"
