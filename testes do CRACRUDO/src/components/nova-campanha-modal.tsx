                ...
                {isLoading ? (
                  ...
                  <>
                    ...
                    <div className="flex items-center gap-3 pt-2">
                      ...
                      <button
                        type="submit"
                        className="flex-[2] flex items-center justify-center gap-1.5 h-11 rounded-xl bg-brand hover:bg-brand-strong text-white dark:text-neutral-950 text-xs font-bold transition shadow-md shadow-brand/10"
                      >
                        <Sparkles size={13} />
