        ...
        {isSuccess ? (
          <div className="rounded-2xl border border-emerald-500/20 bg-emerald-500/5 p-8 text-center space-y-6 animate-alert-pop shadow-2xl shadow-emerald-500/5">
            ...
            <button
              ...
              className="flex items-center gap-1.5 rounded-xl bg-brand hover:bg-brand-strong text-white dark:text-neutral-950 px-6 py-3 text-xs font-bold transition shadow-md shadow-brand/10 mx-auto"
            >
            ...
            <form onSubmit={handleSubmit} className="space-y-5 pt-4 border-t border-line/60">
              {isLoading ? (
                ...
                <>
                  ...
                  <button
                    type="submit"
                    className="flex items-center justify-center gap-1.5 h-11 w-full rounded-xl bg-brand hover:bg-brand-strong text-white dark:text-neutral-950 text-xs font-bold transition shadow-md shadow-brand/10 mt-6"
                  >
                    <Sparkles size={13} />
