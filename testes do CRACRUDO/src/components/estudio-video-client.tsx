  ...
  return (
    <main className="min-h-screen text-foreground relative bg-background select-none">
      <style>{`
        ...
        .scrollbar-thin::-webkit-scrollbar-thumb { background: rgba(248, 195, 102,0.2); border-radius: 99px; }
        .scrollbar-thin::-webkit-scrollbar-thumb:hover { background: rgba(248, 195, 102,0.4); }
      `}</style>
        ...
        <div className="shrink-0 flex flex-col gap-3" style={{ maxHeight: "38%" }}>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <h1 className="font-divine text-xl sm:text-2xl font-black tracking-widest bg-gradient-to-r from-brand via-amber-200 to-brand-strong bg-clip-text text-transparent drop-shadow-[0_0_25px_rgba(248, 195, 102,0.3)]">
                ...
                <div key={key} className="relative shrink-0">
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-3 py-2 rounded-lg text-[10px] font-extrabold uppercase tracking-wider border transition-all duration-200 ${
                      isActive
                        ? "border-brand bg-brand/10 text-brand shadow-[0_0_15px_rgba(248, 195, 102,0.15)]"
